...
const MODULE_VERSION = "2026-08-26-amazon-kl18155-live-v1.0.0";
const ROUTE = "/amazon/listing/kl18155-repair-live";
...
const GUARD = Object.freeze({
  ...
  minPrice: 54000,
  maxPrice: 90000,
  priorPreviewSubmissionId: "b1bdf42e9a1042a48be24156c735f7d8",
  confirmToken: "CONFIRM_KL_18155_EXPIRED_SALE_DELETE_20260826",
});
...
async function handler(req, res) {
  ...
  try {
    ...
    console.error("Amazon KL 18155 live error", err?.message || String(err));
...
express.application.listen = function amazonKl18155LiveListen(...args) {
