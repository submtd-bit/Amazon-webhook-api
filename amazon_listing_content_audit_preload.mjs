...
const MODULE_VERSION = "2026-08-25-amazon-listing-content-audit-v1.0.0";
const ROUTE = "/amazon/listing/content-audit";
...
async function handler(req, res) {
  try {
    ...
    console.error("Amazon listing content audit error", err?.message || String(err));
...
express.application.listen = function amazonListingContentAuditListen(...args) {
