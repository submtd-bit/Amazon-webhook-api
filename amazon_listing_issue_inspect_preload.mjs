...
const MODULE_VERSION = "2026-08-27-amazon-listing-issue-inspect-v1.3.0";
...
function isRelevantAttributeKey(key) {
  return /title|name|brand|manufacturer|model|part|cpu|processor|memory|ram|storage|ssd|hard|operating|system|screen|display|resolution|battery|lithium|watt|hazmat|danger|condition|image|media|un_|norton|software|office/i.test(key);
}
...
async function handler(req, res) {
  try {
    ...
    return res.status(200).json({
      ...
      mainProductImageAttribute: summarizeAttribute(attributes.main_product_image_locator),
