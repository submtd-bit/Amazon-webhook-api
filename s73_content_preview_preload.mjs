...
const MODULE_VERSION = "2026-08-25-s73-content-preview-v1.0.0";
const ROUTE = "/amazon/listing/s73-content-preview";
...
function buildPatches(attributes) {
  return [
    ...
    {
      op: "replace",
      path: "/attributes/specific_uses_for_product",
      value: buildValueRows(attributes, "specific_uses_for_product", [TARGET.specificUse]),
    },
  ];
}
  ...
  try {
    ...
    return res.status(200).json({
      ...
      targetLengths: {
        ...
        specificUse: [...TARGET.specificUse].length,
      },
      unchanged: {
        brand: GUARD.brand,
        manufacturer: GUARD.manufacturer,
        includedComponents: attributes.included_components || [],
        warranty: attributes.warranty_description || [],
        prices: Array.isArray(listing?.offers) ? listing.offers : [],
    ...
    console.error("S73 content preview error", err?.message || String(err));
...
express.application.listen = function s73ContentPreviewListen(...args) {
